<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="CondicionesDeVenta.aspx.cs" Inherits="crm_valvulas_industriales.CondicionesDeVenta" %>
...
<ol class="breadcrumb">
          ...
          <li class="active">Condiciones de Venta</li>
    </ol>
        ...
        <h4>Condición de Venta</h4>
                <div class="form-inline">
                    ...
                    <asp:Button ID="btnBuscar" runat="server" CssClass="btn btn-primary btn-sm" 
                        ...
                        />
                        <asp:Button ID="btnNuevoCondicionComercial" runat="server" Text="Nueva Condición de Venta" 
        ...
        <asp:GridView ID="grvProductos" runat="server" CssClass="table table-bordered table-hover table-condensed table small" HeaderStyle-CssClass="active" PagerStyle-CssClass="active" AutoGenerateColumns="false" AllowPaging="True" PageSize="15" OnRowDataBound="paginacion_RowDataBound">
                    <Columns>
                        <asp:TemplateField HeaderText="Id">
                            <ItemTemplate>
                                <asp:Label ID="lblId" runat="server" Text='<%# Bind("ID_COND_VENTA") %>' Visible="true"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Nombre">
                            <ItemTemplate>
                                <asp:Label ID="lblCondicionVenta" runat="server" Text='<%# Bind("CONDICION_VENTA") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="Glosa">
                            <ItemTemplate>
                                <asp:Label ID="lblGlosa" runat="server" Text='<%# Bind("GLOSA") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
