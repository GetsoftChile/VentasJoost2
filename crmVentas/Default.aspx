                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <table class="table table-condensed small" id="tablaCliente" runat="server" visible="false">
                                ...
                                <tr id="trRutClientePadreCliente" runat="server" visible="false" class="info">
                ...
                <div class="panel panel-primary">
                    ...
                    <td><b>
                        ...
                        <asp:CalendarExtender ID="txtFecAgendamiento_CalendarExtender" runat="server" 
                                    ...
                                    TargetControlID="txtFecAgendamiento"></asp:CalendarExtender>
                    </td>
                    <td>
                        <b><asp:Label ID="lblHora" Visible="false" runat="server" Text="Hora"></asp:Label></b>
                       ...
                       TooltipMessage="Hora 0:00:00 hasta 23:59:59"
                      ></asp:MaskedEditValidator>
                    ...
                    <td>
                        <b><asp:Label ID="lblFechaVisita" Visible="false" runat="server" Text="Fecha Visita"></asp:Label></b>
                        ...
                        <asp:CalendarExtender ID="CalendarExtender1" runat="server" 
                            Enabled="True" FirstDayOfWeek="Monday" Format="dd-MM-yyyy" 
                            TargetControlID="txtFechaVisita"></asp:CalendarExtender>
                    </td>
                  ...
                  <div class="panel-heading">
                    ...
                    <table class="table table-condensed small">
                        ...
                        <tr class="active">
                            ...
                            <td><asp:TextBox ID="txtObservacionCliente" runat="server"  CssClass="form-control input-sm"></asp:TextBox></td>
                  ...
                  <div class="panel-heading">
                    ...
                    <table class="table table-condensed small">
                        ...
                        <tr class="active">
                            ...
                            <td><strong>Email 2</strong></td>
                            <td><asp:TextBox ID="txtEmail2Cotizacion" runat="server" CssClass="form-control input-sm"></asp:TextBox></td>
                        </tr>
                        <tr class="active">
                            <td><strong>Celular</strong></td>
                            <td>
                  ...
                  <div class="panel-heading">
                    ...
                    <table class="table table-condensed small">
                        ...
                        <tr class="active">
                            ...
                            Enabled="True" FirstDayOfWeek="Monday" Format="dd-MM-yyyy" 
                            TargetControlID="txtFechaFacturacion"></asp:CalendarExtender>
                            </td>
                        </tr>
