<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="Canal.aspx.cs" Inherits="crm_fadonel.Canal" %>
        ...
        <h4>Canal</h4>
                <div class="form-inline">
                    ...
                    <asp:Button ID="btnBuscar" runat="server" CssClass="btn btn-primary btn-sm" 
                        ...
                        />
                        <asp:Button ID="btnNuevoProducto" runat="server" Text="Nuevo Canal" 
                        CssClass="btn btn-success btn-sm" onclick="btnNuevoProducto_Click"/>
                </div>
            </div>
        </asp:Panel>


        <asp:GridView ID="grvCanal" runat="server" CssClass="table table-bordered table-hover table-condensed table small" HeaderStyle-CssClass="active" PagerStyle-CssClass="active" AutoGenerateColumns="false" AllowPaging="True" PageSize="15" OnRowDataBound="paginacion_RowDataBound">
                    <Columns>
                        <asp:TemplateField HeaderText="Id Canal">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="Canal">
                            <ItemTemplate>
                                <asp:Label ID="lblNombreCanal" runat="server" Text='<%# Bind("NOM_CANAL") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
