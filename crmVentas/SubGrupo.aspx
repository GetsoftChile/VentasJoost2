<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="SubGrupo.aspx.cs" Inherits="crm_fadonel.SubGrupo" %>
...
<br />
    ...
    <ContentTemplate>
        ...
        <h4>Sub Grupo</h4>
                <div class="form-inline">
                    ...
                    <asp:Button ID="btnBuscar" runat="server" CssClass="btn btn-primary btn-sm" 
                        ...
                        />
                    <asp:Button ID="btnNuevoGrupo" runat="server" Text="Nuevo Sub-Grupo" 
        ...
        <asp:GridView ID="grvGrupo" runat="server" CssClass="table table-bordered table-hover table-condensed table small" HeaderStyle-CssClass="active" PagerStyle-CssClass="active" AutoGenerateColumns="false" AllowPaging="True" PageSize="15" OnRowDataBound="paginacion_RowDataBound">
            <Columns>
                <asp:TemplateField HeaderText="Id Sub-Grupo">
                    <ItemTemplate>
                        <asp:Label ID="lblIdSubGrupo" runat="server" Text='<%# Bind("ID_SUB_GRUPO") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Nombre Sub-Grupo">
                    <ItemTemplate>
                        <asp:Label ID="lblNombreSubGrupo" runat="server" Text='<%# Bind("NOM_SUB_GRUPO") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Id Sub-Grupo">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Nombre Grupo">
                    <ItemTemplate>
                  ...
                  <div class="panel-heading">
                    ...
                    <table class="table table-condensed small">
                        <tr class="active">
                            ...
                            <td><strong>Id SubGrupo</strong>
                                <asp:TextBox ID="txtIdSubGrupo" Width="50px" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                            </td>
