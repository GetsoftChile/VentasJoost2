...
namespace crm_valvulas_industriales
{
    public partial class Agendamiento : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!this.Page.IsPostBack)
                {
                    ...
                    txtFechaHastaAgendamiento.Text = (hoy.AddDays(30)).ToString("dd-MM-yyyy");
                    buscarAgendamientos();
                }
            }
            catch (Exception ex)
        ...
        void buscarAgendamientos()
        {
            ...
            DataTable dt = dal.getBuscarGestionesConAgendamiento(txtFechaDesdeAgendamiento.Text, txtFechaHastaAgendamiento.Text).Tables[0];
