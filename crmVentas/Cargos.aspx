<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="Cargos.aspx.cs" Inherits="crm_valvulas_industriales.Cargos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ContentTemplate>
        ...
        <h4>Cargo</h4>
                <div class="form-inline">
                    ...
                    <asp:Button ID="btnBuscar" runat="server" CssClass="btn btn-primary btn-sm" 
                        ...
                        />
                        <asp:Button ID="btnNuevoGrupo" runat="server" Text="Nuevo Cargo" 
        ...
        <asp:GridView ID="grvGrupo" runat="server" CssClass="table table-bordered table-hover table-condensed table small" HeaderStyle-CssClass="active" PagerStyle-CssClass="active" AutoGenerateColumns="false" AllowPaging="True" PageSize="15" OnRowDataBound="paginacion_RowDataBound">
            <Columns>
                <asp:TemplateField HeaderText="Id Cargo">
                    <ItemTemplate>
                        <asp:Label ID="lblIdGrupo" runat="server" Text='<%# Bind("ID_CONTACTO_CARGO") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Nombre">
                    <ItemTemplate>
                        <asp:Label ID="lblNombreGrupo" runat="server" Text='<%# Bind("CONTACTO_CARGO") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                  ...
                  <div class="panel-heading">
                    ...
                    <table class="table table-condensed small">
                        <tr class="active">
                            ...
                            <td width="200px"><strong>Nombre</strong>
                                <asp:TextBox ID="txtNombre" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                            </td>
                            <td><strong>Activo</strong>
                                <asp:DropDownList ID="ddlActivo" runat="server" CssClass="form-control input-sm" Width="100px">
